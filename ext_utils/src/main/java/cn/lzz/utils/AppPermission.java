...
public class AppPermission {
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static String[] getNeedPermission(Activity activity) {
        String[] permissions = getAllPermissions(activity);
        List<String> filterPermissions = null;
        if (permissions != null) {
            filterPermissions  = filterSameGroup(permissions);
        }
        String[] strings = new String[filterPermissions.size()];
        filterPermissions.toArray(strings);
        return strings;
    }
