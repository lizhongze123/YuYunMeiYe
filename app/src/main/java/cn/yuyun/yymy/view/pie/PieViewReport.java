...
public class PieViewReport extends View {
    ...
    public PieViewReport(Context context) {
        this(context, null);
    }

    public PieViewReport(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 内圆半径
        float r2 = (float) mRadius * 0.5f;
        float r3 = (float) mRadius * 0.55f;
        //内圆阴影,立体感
