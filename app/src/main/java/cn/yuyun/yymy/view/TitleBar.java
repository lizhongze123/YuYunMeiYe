...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void obtainAttrs(Context context, AttributeSet attrs) {
        ...
        left_button_textColor = typedArray.getColor(R.styleable.TitleBar_left_button_textColor, Color.WHITE);
        left_button_textSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_left_button_textSize, sp2px(context, 14));

        /**标题相关*/
        title_background_color = typedArray.getColor(R.styleable.TitleBar_title_bg, Color.WHITE);
        ...
        right_button_textColor = typedArray.getColor(R.styleable.TitleBar_right_button_textColor, Color.WHITE);
