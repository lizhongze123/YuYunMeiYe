 ...
 * @date 2018/10/4
 */
public class MemberDetailPopup extends PopupWindow{

    private Context context;

    public MemberDetailPopup(Context context) {
        super(context);
    ...
    private void initalize() {
        ...
        View view = inflater.inflate(R.layout.popupwindow_member_detail, null);
...
//        showAsDropDown(view, Math.abs((view.getWidth() - getWidth()) / 2), 10);
    ...
    public MemberDetailPopup setOnPopupClickListener(OnPopupClickListener listener) {
