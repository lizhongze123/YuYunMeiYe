...
public class ResetPwdActivity extends AppCompatActivity {
    ...
    private void submit(final String phoneNum, final String verificationCode, final String pwd) {
        ...
        AppModelFactory.model().resetPwd(body, new ProgressSubscriber<DataBean<Object>>(this) {
            ...
            public void onNext(DataBean<Object> result) {
                ...
                AppUtils.clearThisUserInfo(ResetPwdActivity.this);
                //要先设置tooken
    ...
    private void getVerificationCode(final String phoneNum) {
        AppModelFactory.model().getVerificationCode(phoneNum, new ProgressSubscriber<DataBean<Object>>(ResetPwdActivity.this) {
    ...
    private class TextChange implements TextWatcher {
        ...
        public void onTextChanged(CharSequence cs, int start, int before,
            ...
            if (sign1 & sign2 & sign3) {
                ...
                tvSubmit.setBackground(ResoureUtils.getDrawable(ResetPwdActivity.this, R.drawable.login_button_selector2));
                tvSubmit.setTextColor(ResoureUtils.getColor(ResetPwdActivity.this, R.color.colorPrimary));
            } else {
                tvSubmit.setEnabled(false);
                tvSubmit.setBackground(ResoureUtils.getDrawable(ResetPwdActivity.this, R.drawable.login_button_selector3));
                tvSubmit.setTextColor(ResoureUtils.getColor(ResetPwdActivity.this, R.color.text_gray));
            }
