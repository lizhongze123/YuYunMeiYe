 ...
 * @date
 */
public class ActionsCommentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<ResultActivityComment> dataList = new ArrayList<>();
    OnMyItemClickListener onItemClickListener;

    public ActionsCommentListAdapter(Context context){
    ...
    public void notifyDataSetChanged(List<ResultActivityComment> dataList) {
        this.dataList.clear();
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }

    public void addAll(List<ResultActivityComment> dataList) {
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view,  ActionsCommentListAdapter.OnMyItemClickListener onItemClickListener) {
            super(view);
        ...
        private void bindItem(final ResultActivityComment bean, final int position) {
