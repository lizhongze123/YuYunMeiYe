...
public class AnalysisTwoAllActivity extends BaseActivity {
    ...
    public static Intent startAnalysisTwoActivity(Context context, RequestAnalysisOne requestAnalysisOne) {
        return new Intent(context, AnalysisTwoAllActivity.class).putExtra(EXTRA_DATA, requestAnalysisOne);
    }
    ...
    private void initViews() {
        ...
        rightAdapter.setOnItemClickListener(new AnalysisTwoRightAdapter.OnMyItemClickListener() {
            ...
            public void onItemClick(ResultAnalysisOne bean, int position) {
                ...
                startActivity(AnalysisThreeAllActivity.startAnalysisThreeActivity(mContext, requestReport));
            }
        });
    }
