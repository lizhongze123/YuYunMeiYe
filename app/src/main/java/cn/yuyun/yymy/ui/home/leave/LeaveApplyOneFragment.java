 ...
 * @date
 */
public class LeaveApplyOneFragment extends BaseNoTitleFragment {
    ...
    public static LeaveApplyOneFragment newInstance(StaffBean staffBean) {
        LeaveApplyOneFragment fragment = new LeaveApplyOneFragment();
        ...
        presenter.setLoadDataListener(new Presenter2.OnPresenterLoadListener<LeaveBean>() {
            ...
            public void onLoad(Subscriber<DataBean<PageInfo<LeaveBean>>> subscriber, int pageIndex, int pageSize) {
                ...
                if (staffBean == null) {
                    ...
                    AppModelFactory.model().getApplyLeaveList(staffId, 1, pageIndex, pageSize, subscriber);
                } else {
