...
public class AnalysisOneActivity extends BaseActivity {
    ...
    public static Intent startAnalysisOneActivity(Context context, StoreBean storeBean) {
        return new Intent(context, AnalysisOneActivity.class).putExtra(EXTRA_DATA, storeBean);
    }
    ...
    private void initViews() {
        ...
        rightAdapter.setOnItemClickListener(new AnalysisOneRightAdapter.OnMyItemClickListener() {
            ...
            public void onItemClick(ResultAnalysisOne bean, int position) {
                startActivity(AnalysisTwoActivity.startAnalysisTwoActivity(mContext, bean.good_brand_id, storeBean, requestReport));
            }
        });
