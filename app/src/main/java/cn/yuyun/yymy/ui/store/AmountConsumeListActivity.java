...
public class AmountConsumeListActivity extends BaseActivity {
    ...
    public static Intent startAmountConsumeListActivity(Context context, List<String> spIdList, String groupId) {
        return new Intent(context, AmountConsumeListActivity.class).putExtra(EXTRA_DATA, (Serializable) spIdList).putExtra(EXTRA_DATA2, groupId);
    }
    ...
    private void initViews() {
        ...
        mAdapter = new ResultsAdapter(this, 2);
    ...
    private void getAmount() {
        AppModelFactory.model().getAmountConsumeList(requestBean, pageIndex,pageSize, new ProgressSubscriber<DataBean<ResultTotalAmountOut>>(mContext) {
