...
public class ImageNineAdapter extends RecyclerView.Adapter<ImageNineAdapter.ViewHolder> {
    private List<String> mData;
    private Context mContext;
    private boolean isClick;
    private boolean isSave;

    public ImageNineAdapter(Context context, List<String>list, boolean isClick) {
        this.mData = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_detail_imageitem, parent, false);
