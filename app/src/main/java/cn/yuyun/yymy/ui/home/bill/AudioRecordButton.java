...
import cn.yuyun.yymy.utils.AudioManager;
import cn.yuyun.yymy.utils.DialogManager;
import cn.yuyun.yymy.utils.FileUtils;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!isRecording || mTime < 0.8f) {
                    ...
                    // 持续1.3s
                    mStateHandler.sendEmptyMessageDelayed(MSG_DIALOG_DIMISS, 1300);
