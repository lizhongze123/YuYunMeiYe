...
public class CallbackAdapter extends RecyclerView.Adapter<CallbackAdapter.ViewHolder>{
    ...
    private List<ResultCallback> dataList = new ArrayList<>();
    ...
    public void notifyDataSetChanged(List<ResultCallback> dataList) {
        this.dataList.clear();
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }

    public void addAll(List<ResultCallback> dataList) {
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private CallbackAdapter.OnMyItemClickListener onItemClickListener;
        @BindView(R.id.rl)
        RelativeLayout rl;
        ...
        ViewHolder(View view,  CallbackAdapter.OnMyItemClickListener onItemClickListener) {
            super(view);
            ButterKnife.bind(this, view);
            this.onItemClickListener = onItemClickListener;
        }

        private void bindItem(final ResultCallback bean, final int position) {
            ...
            TextViewUtils.setTextOrEmpty(tvTime, DateTimeUtils.StringToDate(bean.visTime, DateTimeUtils.FORMAT_DATETIME_UI, DateTimeUtils.FORMAT_DATETIME_TWO));
    ...
    public interface OnMyItemClickListener {
        void onItemClick(View view, ResultCallback bean, int position);
    }
