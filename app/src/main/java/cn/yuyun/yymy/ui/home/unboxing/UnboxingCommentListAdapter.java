 ...
 * @date
 */
public class UnboxingCommentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<ResultUnboxingComment> dataList = new ArrayList<>();
    OnMyItemClickListener onItemClickListener;

    public UnboxingCommentListAdapter(Context context){
    ...
    public void notifyDataSetChanged(List<ResultUnboxingComment> dataList) {
        this.dataList.clear();
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }

    public void addAll(List<ResultUnboxingComment> dataList) {
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view,  UnboxingCommentListAdapter.OnMyItemClickListener onItemClickListener) {
            super(view);
        ...
        private void bindItem(final ResultUnboxingComment bean, final int position) {
