...
public class ReportBusinessStatisticsActivity extends BaseActivity {
    ...
    public static Intent startBusinessReportActivity(Context context, StoreBean bean) {
        return new Intent(context, ReportBusinessStatisticsActivity.class).putExtra(EXTRA_DATA, bean);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report_business_statistics);
    }
    ...
    private void initViews() {
        ...
        monthPickerView = new TimePickerBuilder(mContext, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {
                ...
                if(!tvStart.getText().toString().substring(0, 4).equals(tvEnd.getText().toString().substring(0, 4))){
