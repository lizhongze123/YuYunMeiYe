 ...
 * @date
 */
public class RevisitForStaffAdapter extends RecyclerView.Adapter<RevisitForStaffAdapter.ViewHolder> {
    ...
    public RevisitForStaffAdapter(Context context) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bindItem(final ResultCallback bean, final int position) {
            ...
            TextViewUtils.setTextOrEmpty(tvTime, bean.visTime);
