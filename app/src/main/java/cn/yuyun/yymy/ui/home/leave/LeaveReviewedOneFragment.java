 ...
 * @date
 */
public class LeaveReviewedOneFragment extends BaseNoTitleFragment {
    ...
    public static LeaveReviewedOneFragment newInstance(StaffBean staffBean) {
        LeaveReviewedOneFragment fragment = new LeaveReviewedOneFragment();
    ...
    private void configurePresenter() {
        ...
        presenter.setLoadDataListener(new Presenter2.OnPresenterLoadListener<LeaveBean>() {
            ...
            public void onLoad(Subscriber<DataBean<PageInfo<LeaveBean>>> subscriber, int pageIndex, int pageSize) {
                AppModelFactory.model().getLeaveListToMe(LoginInfoPrefs.getInstance(mContext).getStaffId(), 1, pageIndex, pageSize, subscriber);
            }
        });
    }
