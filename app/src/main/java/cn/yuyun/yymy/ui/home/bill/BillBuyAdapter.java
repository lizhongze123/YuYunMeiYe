 ...
 * @date
 */
public class BillBuyAdapter extends RecyclerView.Adapter<BillBuyAdapter.ViewHolder> {

    private int RESOURCE_ID = R.layout.item_bill_report_child_buy;
    private Context mContext;
    private List<BillAllInfoBean> dataList = new ArrayList<>();
    OnMyItemClickListener onItemClickListener;

    public BillBuyAdapter(Context context) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bindItem(final BillAllInfoBean bean, final int position) {
            ...
            tvThree.setText("消费金额：" + StringFormatUtils.formatTwoDecimal(bean.transaction_price));
            ...
            tvEight.setText("详单编号：" + bean.bill_buy_id);
