...
public class StoreBillHqActivity extends BaseNoTitleActivity {
    ...
    public static Intent startStoreBillActivity(Context context, List<String> tempSpIdList, List<ResultClassfiyStoreBean.OgServiceplacesRspListBean> storeList, String groupId) {
        return new Intent(context, StoreBillHqActivity.class).putExtra(EXTRA_DATA2, (Serializable) tempSpIdList).putExtra(EXTRA_DATA, (Serializable) storeList).putExtra(EXTRA_TYPE, groupId);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_store_bill_hq);
    }
    ...
    private void initData() {
        requestStoreBill.spId = tempSpIdList;
    ...
    private void initViews() {
        ...
        adapter.setOnItemClickListener(new BillManageConsumeAdapte.OnMyItemClickListener() {
            ...
            public void onItemClick(View view, ResultBillManage bean, int position) {
                startActivity(StoreBillDetailActivity.startStoreBillDetailActivityConsume(mContext, bean, groupId));
            }
        });
        ...
        adapter2.setOnItemClickListener(new BillManageConsumeAdapte.OnMyItemClickListener() {
            @Override
            public void onItemClick(View view, ResultBillManage bean, int position) {
                startActivity(StoreBillStorevalueDetailActivity.startStoreBillStorevalueDetailActivity(mContext, bean, groupId));
            }
        });
    ...
    private void configurePresenter() {
        ...
        presenter.setLoadDataListener(new Presenter2.OnPresenterLoadListener<ResultBillManage>() {
            ...
            public void onLoad(Subscriber<DataBean<PageInfo<ResultBillManage>>> subscriber, int pageIndex, int pageSize) {
                AppModelFactory.model().getStoreConsumeBill(requestStoreBill, groupId, pageIndex, ps, subscriber);
            }
        });
    }
    ...
    private void configurePresenter2() {
        ...
        presenter2.setLoadDataListener(new Presenter2.OnPresenterLoadListener<ResultBillManage>() {
            ...
            @Override
            public void onLoad(Subscriber<DataBean<PageInfo<ResultBillManage>>> subscriber, int pageIndex, int pageSize) {
                AppModelFactory.model().getStoreStoredvalueBill(requestStoreBill, groupId, pageIndex, ps, subscriber);
            }
        });
    }
