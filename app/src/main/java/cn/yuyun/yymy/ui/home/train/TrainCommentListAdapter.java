...
import cn.yuyun.yymy.http.result.ResultTrainDetail;
 ...
 * @date
 */
public class TrainCommentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<ResultTrainComment> dataList = new ArrayList<>();
    OnMyItemClickListener onItemClickListener;

    public TrainCommentListAdapter(Context context){
    ...
    public void notifyDataSetChanged(List<ResultTrainComment> dataList) {
        this.dataList.clear();
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }

    public void addAll(List<ResultTrainComment> dataList) {
        this.dataList.addAll(dataList);
        notifyDataSetChanged();
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view,  TrainCommentListAdapter.OnMyItemClickListener onItemClickListener) {
            super(view);
        ...
        private void bindItem(final ResultTrainComment bean, final int position) {
            TextViewUtils.setTextOrEmpty(profile_name, bean.createPersonName);
            TextViewUtils.setTextOrEmpty(tv_content, bean.content);
            TextViewUtils.setTextOrEmpty(profile_time, bean.createTime);
