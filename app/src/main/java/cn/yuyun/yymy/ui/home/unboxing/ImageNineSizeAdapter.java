...
public class ImageNineSizeAdapter extends RecyclerView.Adapter<ImageNineSizeAdapter.ViewHolder> {
    private List<String> mData;
    private Context mContext;
    private boolean isClick;
    private boolean isSave;

    public ImageNineSizeAdapter(Context context, List<String>list, boolean isClick) {
        this.mData = list;
