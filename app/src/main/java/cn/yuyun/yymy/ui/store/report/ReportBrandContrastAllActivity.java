...
public class ReportBrandContrastAllActivity extends BaseActivity {
    ...
    public static Intent startReportBrandContrastActivity(Context context, StoreBean bean, RequestReportBrandContrast body) {
        return new Intent(context, ReportBrandContrastAllActivity.class).putExtra(EXTRA_DATA, bean).putExtra(EXTRA_DATA2, body);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_report_brand_contrast_all);
    }
