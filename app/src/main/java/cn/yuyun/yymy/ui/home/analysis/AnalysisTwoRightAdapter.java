 ...
 * @date
 */
public class AnalysisTwoRightAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private int RESOURCE_ID = R.layout.item_analysis_two_row;
    private Context context;
    private List<ResultAnalysisOne> dataList = new ArrayList<>();
    OnMyItemClickListener onItemClickListener;

    public AnalysisTwoRightAdapter(Context context) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private AnalysisTwoRightAdapter.OnMyItemClickListener onItemClickListener;
        private RelativeLayout rl;
        TextView tvOne, tvTwo, tvThree, tvFour, tvFive, tvStoreName, tvGoodsName;

        ViewHolder(View view, AnalysisTwoRightAdapter.OnMyItemClickListener onItemClickListener) {
            super(view);
