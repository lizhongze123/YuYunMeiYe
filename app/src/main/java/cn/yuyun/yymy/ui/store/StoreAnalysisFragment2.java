 ...
 * @date
 */
public class StoreAnalysisFragment2 extends BaseNoTitleFragment {
    ...
    public static StoreAnalysisFragment2 newInstance(List<String> spIdList, String groupId) {
        StoreAnalysisFragment2 fragment = new StoreAnalysisFragment2();
    ...
    protected void initViews(View root) {
        ...
        mAdapter = new StoreAnalysisAdapter(mContext, 1);
    ...
    private void getAmount() {
        AppModelFactory.model().storeAnalysis(requestBean, pageIndex, pageSize, new ProgressSubscriber<DataBean<ResultStoreAnalysisOut>>(mContext) {
            ...
            public void onNext(DataBean<ResultStoreAnalysisOut> result) {
                if(null != result.data){
                    tvAmount.setText(StringFormatUtils.formatTwoDecimal(result.data.amount.arrears));
