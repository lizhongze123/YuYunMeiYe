...
public class CommunicationListForStaffFragment extends BaseNoTitleFragment {
    ...
    private CommunicationForStaffAdapter mAdapter;
    ...
    public static CommunicationListForStaffFragment newInstance(StaffBean staffBean, StoreBean storeBean) {
        CommunicationListForStaffFragment fragment = new CommunicationListForStaffFragment();
    ...
    protected void initViews(View root) {
        ...
        mAdapter = new CommunicationForStaffAdapter(mContext);
    ...
    private void configurePresenter() {
        ...
        presenter.setLoadDataListener(new Presenter2.OnPresenterLoadListener<ResultCommunication>() {
            ...
            public void onLoad(Subscriber<DataBean<PageInfo<ResultCommunication>>> subscriber, int pageIndex, int pageSize) {
                AppModelFactory.model().getCommunicationListStaff(staffBean.staffId, storeBean.group_id, start, end, pageIndex, pageSize, subscriber);
            }
        });
    }
